...
public interface OrderService {
	...
	Long adminCountOrders(Integer status);
	...
	Map<Integer, List<Integer>> adminGetYearsOrders();
	Map<Integer, BigDecimal> adminReportIncomeByYear(Integer year);
	Map<Integer, BigDecimal> adminReportIncomeByMonth(Integer year, Integer month);
	...
	boolean cancelOrder(Integer idOrder);
